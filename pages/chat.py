...
.chat-container {
    border: 2px solid red; /* Красная рамка вокруг чата */
    border-radius: 10px;
    padding: 10px;
...
.user-message {
    ...
    float: right; /* Выровнять сообщения пользователя по правому краю */
}
.assistant-message {
    text-align: left;
    background-color: #f1f0f0;
    float: left; /* Выровнять сообщения ассистента по левому краю */
}
</style>
"""
...
# Создание контейнера для заголовка и изображения
st.markdown(
    """
...
# Контейнер для всех сообщений с красной рамкой
...
# Закрытие контейнера для новых сообщений
st.markdown('</div>', unsafe_allow_html=True)
